package uk.cak.cpp.fabric.foundation.network;
...
public enum CppPackets {
    ...
    public static final ResourceLocation CHANNEL_NAME = CreatePlusPlus.asResource("main");
    ...
    <T extends SimplePacketBase> CppPackets(Class<T> type, Function<FriendlyByteBuf, T> factory,
